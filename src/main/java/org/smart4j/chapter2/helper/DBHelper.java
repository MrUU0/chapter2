...
public class DBHelper {
    ...
    public static <T> List<T> queryList(Class<T> clazz, String sql, Object... params){
        List<T> resList = null;
        try{
            resList = QUERY_RUNNER.query(getConnection(), sql, new BeanListHandler<T>(clazz), params);
        }catch( SQLException e) {
    ...
    public static <T> T queryEntity(Class<T> clazz, String sql, Object... params){
        T entity = null;
        try {
            entity = QUERY_RUNNER.query( getConnection(), sql, new BeanHandler<T>(clazz), params);
        } catch (SQLException e) {
    ...
    public static <T> List<Map<String, Object>> query(String sql, Object... params){
        ...
        try{
            resList = QUERY_RUNNER.query( getConnection(), sql, new MapListHandler(), params);
        }catch(Exception e){
